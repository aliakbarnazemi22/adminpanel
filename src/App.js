...
function App({ sidebar2 }) {
  // Use state to open and close sidebar
  const [sidebar2, setSidebar2] = useState(sidebarOpen);

  const toggleSidebar = () => {
    setSidebar2((prevIsVisible) => !prevIsVisible);
  };
  ...
  return (
    <div className="App">
      <div className="flex justify-between gap-0 fixed top-0 w-full">
        ...
        <div
          className={
            "transition2" && sidebar2 === true
              ? "w-1/4 xl:w-[15%] h-full min-h-[100vh] bg-white p-4 transition2 max-h-[100vh] overflow-y-auto hidden lg:block"
              : "w-auto h-full min-h-[100vh] bg-white p-4 transition2 hidden lg:block"
          }
        >
          {sidebar === false ? (
            <SidebarClose />
        ...
        <Header sidebarOpen={sidebarOpen} searchOpen={searchOpen} />
      </div>
      ...
      <div
        className={
          sidebar2 === false
            ? "2xl:w-[95%] w-[90%] mt-[75px] h-[90vh] lg:py-6 py-4 px-4 md:px-16 fixed left-0 overflow-x-auto z-0"
            : "w-full lg:w-[75%] xl:w-[85%] mt-[75px] h-[90vh] py-4 lg:py-6 px-4 lg:px-16 fixed left-0 z-0 overflow-x-auto"
        }
      >
        <Content />
      </div>
      ...
      {/* Start Search Modal */}
      {search === true ? (
        <div className="absolute top-0 left-0 w-full h-full z-50 bg-[rgba(0,0,0,0.4)] backdrop-blur-lg py-16 flex justify-center">
          <div className="w-[95%] sm:w-[90%] md:w-[70%] lg:w-1/2 xl:w-[30%] p-3 h-[fit-content] rounded-2xl bg-white">
            <div className="w-full flex justify-between items-center">
              <form action="" className="flex items-center gap-4">
                ...
                <input
                  type="text"
                  className="focus:outline-none font-bold mt-[3px]"
                  placeholder="جستجو..."
                />
              </form>
              <button
                className="text-[13px] py-1 px-2 border border-gray-200 rounded-md"
            ...
            <div className="py-5 px-4">
              <p className="font-bold text-[0.95rem]">پیشنهاد شده</p>
      ...
      {sidebar2 === false ? (
        <div className="absolute top-0 left-0 w-full h-full z-c1 bg-[rgba(0,0,0,0.4)] py-16 flex justify-center lg:hidden">
