  ...
  return (
    <div className="App">
      <div className='flex justify-between gap-0 fixed top-0 w-full'>
        ...
        {/* Start Sidebar */}
        <div className={'transition2' && sidebar === true ? 'w-[15%] h-full min-h-[100vh] bg-white p-4 transition2 max-h-[100vh] overflow-y-auto' : 'w-auto h-full min-h-[100vh] bg-white p-4 transition2'}>
